...
//#endif      //  End of "INCLUDE_WEB_FUNCTIONS" section
        ...
        private static void WriteDataTableToExcelWorksheet(DataTable dt, WorksheetPart worksheetPart)
        {
            ...
            Cell cell1 = new Cell() { CellReference = "A", DataType = CellValues.String };
            Cell cell2 = new Cell() { CellReference = "B", DataType = CellValues.String };
            cell1.Append(new CellValue("Date"));
            string when = DateTime.Now.ToString();
            cell2.Append(new CellValue(when));
            titleRow.Append(cell1);
            titleRow.Append(cell2);
            ...
            for (int colInx = 0; colInx < numberOfColumns; colInx++)
            {
                ...
                AppendTextCell(excelColumnNames[colInx], col.ColumnName, headerRow);
        ...
        private static void AppendNumericCell(string cellReference, string cellStringValue, Row excelRow)
        {
            ...
            CellValue cellValue = new CellValue();
            cellValue.Text = cellStringValue ?? "Null";
            cell.Append(cellValue);
            excelRow.Append(cell);
        }
