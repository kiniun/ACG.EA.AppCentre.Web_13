<%@ Page Title="" Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="appPermissionReport.aspx.cs" Inherits="ACG.EA.AppCentre.Web.grpPermissionReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="DashBoardPlaceHolder" runat="server">
    <script src="../Support/Scripts/js/jqGridExportToExcel.js"></script>
        ...
        <%if ((bool)Session["IsAppAdmin"])
          { %>
    <div> 
        <h4><span id="manageAppBox" class="management">User Group Permissions Report</span></h4>
        <table>
            <thead>
                <tr>
                    <td>Application</td>
    ...
    optionsValue: 'group_Id'"></select>
        ...
        .button().click(function (event) {
            ...
            window.onkeypress = function () {
                var rptBtn = $('#showAppGroupPermissions');
                if (rptBtn) {
                    if (event.keyCode == 13)
                        rptBtn.click();
                }
